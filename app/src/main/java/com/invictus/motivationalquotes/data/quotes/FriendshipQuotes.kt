...
object FriendshipQuotes {
    ...
    fun getQuotes(): List<String> {
        return arrayListOf(
            ...
            "A friend is one who overlooks your broken fence and admires the flowers in the garden.",
            ...
            "Never forget that a true friend is someone who understands your past, believes in your future, and accepts you just the way you are.",
